...
public artifact as of 2026-08-11,\footnote{Priority statements in this paper are \emph{surveyed as-of} claims, not assertions of absence. Survey: \texttt{docs/priority-survey-2026-08-11.md} in the released repository (method: adversary-cited, five independent lanes, 2026-08-11); our own landing dates are given in \S\ref{sec:banners} and the results register. Salt is a private tree at the time of writing, so these are firsts \emph{in any public artifact} as of the survey date, and are re-run before submission.} of any zero-free region for
...
\emph{demand-audited hypothesis minimization}, is---on the same survey, as of
2026-08-11---a new mode of mathematical discovery, and it is the sense in which this paper's
...
first time in any public artifact as of 2026-08-11, including a
Littlewood-strength zero-free region for $\zeta$ and the first such
power-saving region in any proof assistant. Second, the
...
survey behind this paper's priority statements found to its cost---and cite
the adversaries instead: the two public Lean formalizations of
Bombieri--Vinogradov both \emph{axiomatize} Siegel--Walfisz and the large
sieve in their own source, and say so.
...
As of the 2026-08-11 survey, Theorem~\ref{thm:pow} is the first zero-free
