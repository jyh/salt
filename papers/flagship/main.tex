...
and kernel verification, whose public error ledger (255 numbered catches,
...
$\forall n\, \exists p \ge n$ with $p$ and $p+2$ prime
...
claim the unconditional dichotomy; we claim the honest one, and we
exhibit exactly what remains.
