...
Bombieri--Vinogradov theorem, and a machine-checked Chen-style corollary
of the present campaign
($\Omega(p(p+2)) \le 3$ infinitely often under the fulcrum's engine
inputs; unconditionally, $\Omega(n(n+2)) \le 20$ infinitely often,
...
explicit constant $C^\star = \max(C^{(1)}, 2/c_0)$, where $c_0$ is the
zero-free-region constant of the corpus (docstring-grade value
$1/126848$).
