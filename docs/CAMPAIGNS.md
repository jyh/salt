...
| 14 | [WALL-3](../Salt/HB/SignChain.lean) | the exchange-rate wall | ✅ | `IsSignFunction` chain (59 decls); `neutrality_rate`; λ = the neutrality point — [ratification](exploration/wall3-d4-ratified.md) |
