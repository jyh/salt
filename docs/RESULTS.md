...
| `Salt.MR.logChowla2_ineffective_v4` | The classical `∃A` terminal with the base-scale cap DISCHARGED inside at the raised lever `KlevF A`. Riders: `cs`, `T₀`, `Ks` on its own constants; conclusion-side: the builder's outer-scale ceiling `log x ≤ (31/ε)·H₊` and the co-factor supply, both at `KlevF A`. | Salt/MR/S16ComposeV4.lean:802 | 2026-08-02 | `9647450` | 3 (Salt/MR/All.lean:7584) |
