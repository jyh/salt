...
`PFR/Mathlib/Probability/Kernel/Composition/Comp.lean`, at commit
...
- Converted the PFR module-system header (`module`; `public import`s of
  Mathlib.Probability.Kernel.Composition.Comp and
  PFR.Mathlib.Probability.Kernel.Disintegration; `public section`) to a plain
  `import Mathlib` plus `import Salt.Entropy.Mathlib.KernelDisintegration` (the
  Salt port of the upstream PFR import, providing `FiniteKernelSupport` and
  `AEFiniteKernelSupport`).
