...
#audit_axioms Salt.HB.S2_sub_S3_honestWindow
  ...
  -- assembly and the one dyadic machine three of them share.  ⛔ `hb_lemma10` is STILL not
  -- here: at `V = 0` these rows' `K/m²` arm outgrows the frozen statement's `log(2k)²` budget
  -- near `k ≈ 1.3·10²⁴` (`docs/blueprints/flags.md`, 2026-09-09).
  ...
  Salt.N7.norm_majorantCoeff_neg Salt.N7.majorant_tsum_split
