...
beside it as the crown-road proof at `P ≤ 2310` — so the set below now has THREE landed names (this
twin, K, and the all-`P` statement), and "meet at ONE theorem" predates S.
