...
def main() -> int:
    ...
    # every redirected CI step) an em-dash silently becomes byte 0x97 while a
    # character outside the table kills the process mid-print. Both were
    # measured on this repository's own gates, 2026-08-31. FIRST statement in
    # main, before argument parsing: argparse prints usage and errors too.
    ensure_utf8_stdout()
